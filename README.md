💻 Sistema BellaPizza
Este é um projeto desenvolvido para a avaliação de Front-End, focado em criar interatividade para 
uma pizzaria, cujo o visual do novo sistema de pedidos estava completamente parado.
...
👨‍💻 Autor
Ana Katy Romão Vasconcellos (https://github.com/avasconcelos-tech)
